        ...
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input v-bind:class="{ 'is-invalid': errors.email, 'is-valid': !errors.email && this.submitted}" v-model="email" type="email" class="form-control" placeholder="Email">
    ...
    methods: {
        registerUser() {
            ...
            .then((response ) => {
                ...
                this.$root.auth = data;
                this.$noty.success('Registered Done');
                this.$router.push('/');
            })
            .catch(({response}) => {
                this.$noty.erroe('Error');
                this.loading = false;
                this.submitted = true;
